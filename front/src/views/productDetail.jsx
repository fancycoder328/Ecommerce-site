      ...
      <section class="py-20 overflow-hidden bg-white font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
          <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 md:w-1/2 ">{/* TODO add image */}</div>
              ...
              <div class="lg:pl-20">
                <div class="pb-6 mb-8 border-b border-gray-200 dark:border-gray-700">
                  ...
                  {/* <div class="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                                        <h2 class="mb-4 text-xl font-semibold dark:text-gray-400">
                                            Real time{" "}
                                            <span class="px-2 bg-blue-500 text-gray-50">
                                                26
                                            </span>
                                            visitors right now!{" "}
                                        </h2>
                ...
                {product.attributes &&
                  product.attributes.map((attribute) => (
                    <div
                      key={attribute.id}
                      className="pb-6 mb-8 border-b border-gray-300 dark:border-gray-700"
                    >
                ...
                <div class="flex flex-wrap items-center ">
                  ...
                  <div class="mb-4 mr-4 lg:mb-0">
                    <button class="w-full h-10 p-2 mr-4 bg-blue-500 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500">
                      Buy Now
                    </button>
                  </div>
                  <div class="mb-4 mr-4 lg:mb-0">
                    <button class="flex items-center justify-center w-full h-10 p-2 text-gray-700 border border-gray-300 lg:w-11 hover:text-gray-50 dark:text-gray-200 dark:border-blue-600 hover:bg-blue-600 hover:border-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 dark:hover:border-blue-500 dark:hover:text-gray-300">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
